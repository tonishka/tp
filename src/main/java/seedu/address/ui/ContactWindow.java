 ...
 */
public class ContactWindow extends UiPart<Stage> {
    ...
    /**
     * Creates a {@code ContactWindow} with the given {@code Stage} and {@code Logic}.
     */
    public ContactWindow(Stage primaryStage, Logic logic) {
    ...
    public ContactDetailsPanel contactDetailsPanel() {
