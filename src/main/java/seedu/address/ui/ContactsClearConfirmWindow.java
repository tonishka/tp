 ...
 */
public class ContactsClearConfirmWindow extends UiPart<Stage> {
    ...
    private static final Logger logger = LogsCenter.getLogger(ContactsClearConfirmWindow.class);
    private static final String FXML = "ContactsClearConfirmWindow.fxml";
    ...
    /**
     * Creates a new ContactsClearConfirmWindow.
     *
     * @param root Stage to use as the root of the HelpWindow.
     */
    public ContactsClearConfirmWindow(Stage root) {
        super(FXML, root);
     ...
     * Creates a new ContactsClearConfirmWindow.
     */
    public ContactsClearConfirmWindow(Logic logic) {
        this(new Stage());
