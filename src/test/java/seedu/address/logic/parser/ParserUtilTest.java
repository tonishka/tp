...
public class ParserUtilTest {
    ...
    public void parsePhone_null_throwsNullPointerException() {
        HashMap<String, Phone> testPhoneMap = new HashMap<>();
        assertThrows(NullPointerException.class, () -> ParserUtil.parsePhone((String) null, testPhoneMap));
    }
    ...
    public void parsePhone_invalidValue_throwsParseException() {
        HashMap<String, Phone> testPhoneMap = new HashMap<>();
        assertThrows(ParseException.class, () -> ParserUtil.parsePhone(INVALID_PHONE, testPhoneMap));
    }

    //***PLEASE DOUBLE CHECK THESE***
    @Test
    public void parsePhone_validValueWithoutLabel_phoneAddedToHashMap() throws Exception {
        HashMap<String, Phone> testPhoneMap = new HashMap<>();
        ParserUtil.parsePhone(VALID_PHONE, testPhoneMap);
        String expectedLabelKey = "";
        String expectedPhoneContent = VALID_PHONE;
        assertEquals(true, testPhoneMap.containsKey(expectedLabelKey));
        assertEquals(expectedPhoneContent, testPhoneMap.get(expectedLabelKey).toString());
    }

    //***PLEASE DOUBLE CHECK THESE***
    @Test
    public void parsePhone_validValueWithLabel_phoneWithLabelAddedToHashMap() throws Exception {
        HashMap<String, Phone> testPhoneMap = new HashMap<>();
        ParserUtil.parsePhone(VALID_PHONE_WITH_LABEL, testPhoneMap);
        String expectedLabelKey = "home";
        String expectedPhoneContent = VALID_PHONE;
        assertEquals(true, testPhoneMap.containsKey(expectedLabelKey));
        assertEquals(expectedPhoneContent, testPhoneMap.get(expectedLabelKey).toString());
    }
    ...
    //***PLEASE DOUBLE CHECK THESE***
    @Test
    public void parsePhone_validValueWithoutLabelWithWhiteSpace_phoneAddedToHashMap() throws Exception {
        HashMap<String, Phone> testPhoneMap = new HashMap<>();
        String phoneWithWhiteSpace = WHITESPACE + VALID_PHONE + WHITESPACE;
        ParserUtil.parsePhone(phoneWithWhiteSpace, testPhoneMap);
        String expectedLabelKey = "";
        String expectedPhoneContent = VALID_PHONE;
        assertEquals(true, testPhoneMap.containsKey(expectedLabelKey));
        assertEquals(expectedPhoneContent, testPhoneMap.get(expectedLabelKey).toString());
    ...
    //***PLEASE DOUBLE CHECK THESE***
    @Test
    public void parsePhone_validValueWithWhitespaceWithLabel_phoneWithLabelAddedToHashMap() throws Exception {
        HashMap<String, Phone> testPhoneMap = new HashMap<>();
        String phoneWithWhiteSpace = WHITESPACE + VALID_PHONE_WITH_LABEL + WHITESPACE;
        ParserUtil.parsePhone(phoneWithWhiteSpace, testPhoneMap);
        String expectedLabelKey = "home";
        String expectedPhoneContent = VALID_ADDRESS;
        assertEquals(true, testPhoneMap.containsKey(expectedLabelKey));
        assertEquals(expectedPhoneContent, testPhoneMap.get(expectedLabelKey).toString());
    }
    ...
    public void parseNumbers_collectionWithInvalidNumbers_throwsParseException() {
        assertThrows(ParseException.class, () -> ParserUtil.parseNumbers(Arrays.asList(VALID_PHONE_WITH_LABEL, INVALID_PHONE)));
    ...
    public void parseNumbers_collectionWithInvalidNumbersPlusLabel_throwsParseException() {
        assertThrows(ParseException.class, () -> ParserUtil.parseNumbers(Arrays.asList(VALID_PHONE, INVALID_PHONE)));
        assertThrows(ParseException.class, () -> ParserUtil.parseNumbers(Arrays.asList(VALID_PHONE, INVALID_PHONE_LABEL_2)));
        assertThrows(ParseException.class, () -> ParserUtil.parseNumbers(Arrays.asList(VALID_PHONE, INVALID_PHONE_LABEL_3)));
    }
    ...
    public void parseNumbers_collectionWithValidNumbers_returnsNumberMap() throws Exception {
        HashMap<String, Phone> actualNumbersMap = ParserUtil.parseNumbers(Arrays.asList(VALID_PHONE, VALID_PHONE_WITH_LABEL));
    ...
    public void parseAddress_null_throwsNullPointerException() {
        HashMap<String, Address> testAddressMap = new HashMap<>();
        assertThrows(NullPointerException.class, () -> ParserUtil.parseAddress((String) null, testAddressMap));
    }
    ...
    public void parseAddress_invalidValue_throwsParseException() {
        HashMap<String, Address> testAddressMap = new HashMap<>();
        assertThrows(ParseException.class, () -> ParserUtil.parseAddress(INVALID_ADDRESS, testAddressMap));
    }

    //***PLEASE DOUBLE CHECK THESE***
    @Test
    public void parseAddress_validValueWithoutLabel_addressAddedToHashMap() throws Exception {
        HashMap<String, Address> testAddressMap = new HashMap<>();
        ParserUtil.parseAddress(VALID_ADDRESS, testAddressMap);
        String expectedLabelKey = "";
        String expectedAddressContent = VALID_ADDRESS;
        assertEquals(true, testAddressMap.containsKey(expectedLabelKey));
        assertEquals(expectedAddressContent, testAddressMap.get(expectedLabelKey).toString());
    }

    //***PLEASE DOUBLE CHECK THESE***
    @Test
    public void parseAddress_validValueWithLabel_addressWithLabelAddedToHashMap() throws Exception {
        HashMap<String, Address> testAddressMap = new HashMap<>();
        ParserUtil.parseAddress(VALID_ADDRESS_WITH_LABEL, testAddressMap);
        String expectedLabelKey = "home";
        String expectedAddressContent = VALID_ADDRESS;
        assertEquals(true, testAddressMap.containsKey(expectedLabelKey));
        assertEquals(expectedAddressContent, testAddressMap.get(expectedLabelKey).toString());
    ...
    //***PLEASE DOUBLE CHECK THESE***
    @Test
    public void parseAddress_validValueWithoutLabelWithWhiteSpace_addressAddedToHashMap() throws Exception {
        HashMap<String, Address> testAddressMap = new HashMap<>();
        String addressWithWhiteSpace = WHITESPACE + VALID_ADDRESS + WHITESPACE;
        ParserUtil.parseAddress(addressWithWhiteSpace, testAddressMap);
        String expectedLabelKey = "";
        String expectedAddressContent = VALID_ADDRESS;
        assertEquals(true, testAddressMap.containsKey(expectedLabelKey));
        assertEquals(expectedAddressContent, testAddressMap.get(expectedLabelKey).toString());
    ...
    //***PLEASE DOUBLE CHECK THESE***
    @Test
    public void parseAddress_validValueWithWhitespaceWithLabel_emailWithLabelAddedToHashMap() throws Exception {
        HashMap<String, Address> testAddressMap = new HashMap<>();
    ...
    public void parseAddresses_collectionWithValidAddresses_returnsAddressesMap() throws Exception {
        HashMap<String, Address> actualAddressesMap = ParserUtil.parseAddressess(Arrays.asList(VALID_ADDRESS, VALID_ADDRESS_WITH_LABEL));
    ...
    public void parseAddresses_collectionWithInvalidAddressesPlusLabel_throwsParseException() {
        assertThrows(ParseException.class, () -> ParserUtil.parseAddressess(Arrays.asList(VALID_ADDRESS, INVALID_ADDRESS)));
        assertThrows(ParseException.class, () -> ParserUtil.parseAddressess(Arrays.asList(VALID_ADDRESS, INVALID_ADDRESS_WITH_LABEL_2)));
        assertThrows(ParseException.class, () -> ParserUtil.parseAddressess(Arrays.asList(VALID_ADDRESS, INVALID_ADDRESS_WITH_LABEL_3)));
    }
    ...
    public void parseEmail_null_throwsNullPointerException() {
        ...
        assertThrows(NullPointerException.class, () -> ParserUtil.parseEmail((String) null, testEmailMap));
    }
    ...
    public void parseEmail_invalidValue_throwsParseException() {
        HashMap<String, Email> testEmailMap = new HashMap<>();
        assertThrows(ParseException.class, () -> ParserUtil.parseEmail(INVALID_EMAIL, testEmailMap));
    }

    //***PLEASE DOUBLE CHECK THESE***
    @Test
    public void parseEmail_validValueWithoutLabel_emailAddedToHashMap() throws Exception {
        HashMap<String, Email> testEmailMap = new HashMap<>();
        ParserUtil.parseEmail(VALID_EMAIL, testEmailMap);
        String expectedLabelKey = "";
        String expectedEmailContent = VALID_EMAIL;
        assertEquals(true, testEmailMap.containsKey(expectedLabelKey));
        assertEquals(expectedEmailContent, testEmailMap.get(expectedLabelKey).toString());
    }

    //***PLEASE DOUBLE CHECK THESE***
    @Test
    public void parseEmail_validValueWithLabel_emailWithLabelAddedToHashMap() throws Exception {
        HashMap<String, Email> testEmailMap = new HashMap<>();
        ParserUtil.parseEmail(VALID_EMAIL_WITH_LABEL, testEmailMap);
        String expectedLabelKey = "friend";
        String expectedEmailContent = VALID_EMAIL;
        assertEquals(true, testEmailMap.containsKey(expectedLabelKey));
        assertEquals(expectedEmailContent, testEmailMap.get(expectedLabelKey).toString());
    }
    ...
    //***PLEASE DOUBLE CHECK THESE***
    @Test
    public void parseEmail_validValueWithWhitespace_emailWithLabelAddedToHashMap() throws Exception {
        HashMap<String, Email> testEmailMap = new HashMap<>();
        String emailWithWhiteSpace = WHITESPACE + VALID_EMAIL + WHITESPACE;
        ParserUtil.parseEmail(emailWithWhiteSpace, testEmailMap);
        String expectedLabelKey = "";
        String expectedEmailContent = VALID_EMAIL;
        assertEquals(true, testEmailMap.containsKey(expectedLabelKey));
        assertEquals(expectedEmailContent, testEmailMap.get(expectedLabelKey).toString());
    ...
    //***PLEASE DOUBLE CHECK THESE***
    @Test
    public void parseEmail_validValueWithWhitespaceWithLabel_emailWithLabelAddedToHashMap() throws Exception {
        HashMap<String, Email> testEmailMap = new HashMap<>();
    ...
    public void parseEmails_collectionWithValidEmails_returnsEmailsMap() throws Exception {
        HashMap<String, Email> actualEmailsMap = ParserUtil.parseEmails(Arrays.asList(VALID_EMAIL, VALID_EMAIL_WITH_LABEL));
    ...
    public void parseEmails_collectionWithInvalidEmailsPlusLabel_throwsParseException() {
        ...
        assertThrows(ParseException.class, () -> ParserUtil.parseEmails(Arrays.asList(VALID_EMAIL, INVALID_EMAIL_WITH_LABEL_1)));
        assertThrows(ParseException.class, () -> ParserUtil.parseEmails(Arrays.asList(VALID_EMAIL, INVALID_EMAIL_WITH_LABEL_2)));
    }
    ...
    public void parsePronouns_collectionWithInvalidPronouns_throwsParseException() {
        assertThrows(ParseException.class, () -> ParserUtil.parsePronouns(Arrays.asList(VALID_PRONOUN, INVALID_PRONOUN)));
    }
    ...
    public void parsePronouns_collectionWithValidPronouns_returnsPronounSet() throws Exception {
        ...
        Set<Pronoun> expectedPronounSet = new HashSet<>(Arrays.asList(new Pronoun(VALID_PRONOUN), new Pronoun(VALID_PRONOUN_2)));
