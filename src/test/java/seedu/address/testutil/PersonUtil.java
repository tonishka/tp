...
public class PersonUtil {
    ...
    public static String getPersonDetails(Person person) {
        ...
        sb.append(PREFIX_COMPANY).append(person.getCompany().map(c -> c.company).orElse("")).append(" ");
        sb.append(PREFIX_JOBTITLE).append(person.getJobTitle().map(j -> j.jobTitle).orElse("")).append(" ");
