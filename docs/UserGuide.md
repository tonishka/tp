...
![Sample Contacts](images/Tutorial/new_sample_contacts.png)
...
![Contact Details Window](images/Tutorial/new_contact_details_added_screen.png)
...
![Company & Job Added](images/Tutorial/new_company_job_added_screen.png)
...
![Email Added](images/Tutorial/new_emails_edited_screen.png)
...
![Full Contact Details](images/Tutorial/new_tag_added_me.png)
10. Now type `back` in the command box to return to the main window. Your **Main Window** should look like this:
![Main Window](images/Tutorial/new_main_window.png)
